...
def GetDataset2017(path: str, rs: RandomState, dataset_format="csv", label="both", filter=True, do_print = True):
    ...
    for file in os.listdir(path):
        ...
        if dataset_format == "csv":
            ...
            if filter:
                ...
                if do_print:
                    print(df_aux[" Label"].value_counts())
            else:
...
def main():
    ...
    df_day = GetDataset2017(sys.argv[1], rs, DATASET_FORMAT, filter=True, do_print=True)
